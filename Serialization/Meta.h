...
#define IG_DEFINE_META_TO_JSON(T) entt::meta<T>().template func<&SerializeTypeUnsafe<nlohmann::json, T>>("ToJson"_hs)
#define IG_DEFINE_META_FROM_JSON(T) entt::meta<T>().template func<&DeserializeTypeUnsafe<nlohmann::json, T>>("FromJson"_hs)